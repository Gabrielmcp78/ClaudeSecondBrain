(Source: `raw/PHYSICS_APPENDIX_B_TOY_MODEL.md`)
...
$$
W_i = \mathcal{P} \exp\left(i \oint_{S^1_i} A_a dy^aight) \in SU(6)
$$
...
$$
ho^2 \sim \frac{35}{12} \approx 2.92
$$

Taking the square root (since d=2):

$$
ho \approx \sqrt{35/12} \approx 1.71
$$
...
$$
ho = \sqrt{\frac{\chi \cdot \dim[SU(6)]}{\dim[SU(3) 	imes SU(2) 	imes U(1)]}}
$$

$$
ho = \sqrt{\frac{6 	imes 35}{12}} = \sqrt{\frac{210}{12}} = \sqrt{17.5} \approx 4.18
$$
...
$$
\frac{1}{g^2(\mu)} = \frac{1}{g^2(\mu_0)} + \frac{b}{16\pi^2} \ln\left(\frac{\mu}{\mu_0}ight)
$$
...
$$
ho_{	ext{eff}} = ho_{	ext{tree}} 	imes e^{b/16\pi^2} \approx 4.18 	imes 1.43 \approx 6.0
$$
